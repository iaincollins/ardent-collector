...
module.exports = (payload) => {
  ...
  // Normalise how Megaships station type, as seems to vary in how it comes through
  if (stationType === 'MegaShip') stationType = 'Megaship' 

  if (!stationTypes.includes(stationType)) {
    console.warn(`Unknown Station Type: ${message?.StationType} ("${message?.StationName}" in "${message?.SystemName}")`)
  }

...
module.exports = (payload) => {
  ...
  if (!stationTypes.includes(message?.StationType)) {
  ...
  if (!maxLandingPadSize) {
    ...
    } else if (stationTypes.includes(message?.StationType) && message?.StationType !== 'OnFootSettlement') {
  ...
  // Ignore these entries with non-human readable names (seem to be colony ships, but the type can come through as Planetary Port)

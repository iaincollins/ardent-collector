...
function ensureIndexes () {
  ...
  // Note: Data should be normalized during ingestion so it's ok to be case sensitive (this was not always the case origionally)
  ...
  // This compiudn indexs specifically improves performance when fetching imports/exports for a particular commodity in a system
  getDatabase().exec('CREATE INDEX IF NOT EXISTS commodities_commodityName_systemName ON commodities (commodityName, systemName)')

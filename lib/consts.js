...
const MAINTENANCE_DAY_OF_WEEK = 4 // 4 is Thursdays, which aligns with when FDev do weekly maintenance
const MAINTENANCE_HOUR = 7 // 7 AM UTC is typically when FDev do weekly maintenance / updates on Thursdays
